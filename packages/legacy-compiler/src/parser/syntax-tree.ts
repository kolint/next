...
export class TypeReferenceNode extends Node {
  public constructor(
    location: Location,
    public ref: IdentifierNode<string>,
...
export class NamedContextNode extends Node {
  public constructor(
    location: Location,
    public ident: IdentifierNode<string>,
  ) {
    super(location, "", NodeType.Empty);
  }
}
...
export class ImportNode extends Node {
  public constructor(
    ...
    public modulePath: IdentifierNode<string>,
  ) {
    super(location, "", NodeType.Empty);
  }
}
...
export class Document {
   ...
   */
  public constructor(
    public viewFilePath: string,
    public rootNode: TypeNode,
...
export class BindingContext {
  ...
  private constructor(
    public parent?: BindingContext,
    public typeAssertion?: string,
...
export abstract class AstNode {
  ...
  public getContext(): BindingContext {
    if (this.childContext) return this.childContext;
    if (this.parent) return this.parent.getContext();
    throw new Error("No top-level context was defined");
  }

  public getParentContext(): BindingContext {
    const parent = this.parent;
    if (!parent) throw new Error("Missing expected parent node.");
...
export class Binding {
   ...
   */
  public constructor(
    public bindingHandler: BindingName,
    public expression: BindingExpression,
  ) {}
}
