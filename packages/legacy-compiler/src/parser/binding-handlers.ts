...
function hasAdditionalTypes(
  bhct: BindingHandlerContextType | undefined,
): bhct is BindingHandlerAdditionalTypesContextType {
  return Boolean(bhct?.additionalTypes);
}

export function wrapBindingHandlerContextTypes(
  bindingHandlers: BindingHandlerContextType[],
  handlersExtenderName: string,
): string {
...
export function getBindingHandlerContextType(
  bindingHandler: BindingHandler,
): BindingHandlerContextType {
